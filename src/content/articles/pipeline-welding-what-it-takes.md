---
title: "Pipeline Welding: What It Takes to Succeed in the Field"
description: "Everything you need to know about pipeline welding jobs. Covers certifications, daily life, pay ranges, API 1104 requirements, and how to break into the trade."
pubDate: 2026-04-20
...
1. **Stringing** — Pipe sections are delivered to the right-of-way and laid end-to-end.
2. **Lineup** — A hydraulic internal lineup clamp aligns adjacent pipe sections.
3. **Root pass** — One or two root welders run the root pass on the aligned joint.
4. **Hot pass** — Immediately after the root, a hot pass team runs a high-heat pass to burn out any oxidation and ensure fusion.
5. **Fill passes** — Fill welders (typically 2 on large-diameter pipe) fill the groove with multiple passes.
6. **Cap pass** — Cap welders finish the weld to the final profile and appearance.
7. **Radiography** — X-ray of the completed joint. Acceptable welds proceed; rejected welds (called "cuts") must be repaired or replaced.
8. **Coating** — The weld area is coated and the pipeline moves to the next section.
